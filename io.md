...
<h2 id="checking-if-something-is-a-file">Checking if Something is a File</h2>

```php
$fileSystem->isFile(FILE_PATH);
```

<h2 id="checking-if-a-file-is-readable">Checking if a File is Readable</h2>

```php
$fileSystem->isReadable(FILE_PATH);
```

<h2 id="checking-if-a-file-is-writable">Checking if a File is Writable</h2>
...
<h2 id="getting-a-files-directory-name">Getting a File's Directory Name</h2>

```php
$fileSystem->getDirectoryName(FILE_PATH);
```

<h2 id="getting-a-files-basename">Getting a File's Basename</h2>
...
<h2 id="getting-a-files-name">Getting a File's Name</h2>
...
<h2 id="getting-a-files-extension">Getting a File's Extension</h2>

```php
$fileSystem->getExtension(FILE_PATH);
```

<h2 id="getting-a-files-size">Getting a File's Size</h2>
...
<h2 id="getting-a-files-last-modified-time">Getting a File's Last Modified Time</h2>

```php
$fileSystem->getLastModified(FILE_PATH);
```

<h2 id="getting-files-in-a-directory">Getting Files in a Directory</h2>
...
<h2 id="getting-files-with-glob">Getting Files with Glob</h2>
...
<h2 id="checking-if-a-file-or-directory-exists">Checking if a File or Directory Exists</h2>

```php
$fileSystem->exists(FILE_PATH);
```

<h2 id="creating-a-directory">Creating a Directory</h2>
...
<h2 id="getting-the-list-of-directories">Getting the List of Directories</h2>
...
<h2 id="copying-a-directory">Copying a Directory</h2>
...
<h2 id="reading-from-stream">Reading from a Stream</h2>
...
<h2 id="writing-to-stream">Writing to a Stream</h2>
...
<h2 id="getting-length-of-stream">Getting the Length of a Stream</h2>
...
<h2 id="copying-to-another-stream">Copying to Another Stream</h2>
...
<h2 id="closing-stream">Closing a Stream</h2>
...
<h2 id="multi-streams">Multi-Streams</h2>
